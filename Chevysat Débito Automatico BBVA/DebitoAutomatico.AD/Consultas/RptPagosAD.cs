...
namespace DebitoAutomatico.AD.Consultas
{
    public class RptPagosAD
    {
        ...
        public string consultaLogErroresAD(String procedimiento, String mensaje, int codigoBanco, String fechaPago, String parteFija)
        {
            try
            {
                string[,,] Param = new string[5, 3, 1];
        ...
        public string actualizaLogErroresAD(String procedimiento, String mensaje, int codigoBanco, String fechaPago, String parteFija)
        {
            try
            {
                string[,,] Param = new string[5, 3, 1];
